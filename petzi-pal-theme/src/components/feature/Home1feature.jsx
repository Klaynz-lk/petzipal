        ...
        <div className="row justify-content-center bg">
          <div className="col-lg-10 gap-4 d-flex align-items-center justify-content-lg-between justify-content-center flex-lg-nowrap flex-wrap ">
            <div className="feature-left">
              <div className="single-card mb-45">
                ...
                <div className="content">
                  <h4>ID Verified</h4>
                  <p>
                    Every PetziPal team member is identity-verified for your
                    peace of mind and your pet’s safety.
                  </p>
                </div>
              </div>
              <div className="single-card">
                ...
                <div className="content">
                  ...
                  <p>
                    All staff undergo thorough background checks, ensuring only
                    trusted professionals care for your pets.
                  </p>
                </div>
              </div>
            </div>
            <div className="freture-title">
              <h2>
                Your Pets Are <span>100% Safe</span> with PetziPal.
              </h2>
            </div>
            <div className="feature-right">
              <div className="single-card mb-45">
                ...
                <div className="content">
                  <h4>Fully Insured</h4>
                  <p>
                    PetziPal services are fully insured, so you and your pet are
                    always protected against the unexpected.
                  </p>
                </div>
              </div>
              <div className="single-card">
                ...
                <div className="content">
                  ...
                  <p>
                    Our team is trained in pet first aid, ready to respond to
                    any situation with care and expertise.
                  </p>
                </div>
              </div>
            </div>
