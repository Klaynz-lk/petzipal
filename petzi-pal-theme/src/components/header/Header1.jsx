        ...
        <div className="container-fluid d-flex justify-content-between align-items-center">
            ...
            <Link legacyBehavior href="/">
              <a className="d-flex align-items-center">
                <img
                  alt="image"
                  className="img-fluid"
                  src="assets/images/PetziLogo.png"
                />
                <span className="logo-name">PetziPal</span>
              </a>
            </Link>
          </div>
          <div
          ...
          >
            ...
            <ul className="menu-list">
              ...
              <li className={currentRoute === "/blog-grid" ? "active" : ""}>
            ...
            <div className="for-mobile-menu d-lg-none d-block">
              ...
              <ul className="social-link mb-5">
                ...
                <li>
                  <Link legacyBehavior href={isLoggedIn ? (userData?.role === 'SERVICE_PROVIDER' ? "/service-provider-manage" : "/profile") : "/login"}>
                    <a>
                      <svg
                        width={15}
                        height={15}
                    ...
                    {showProfileDropdown && (
                      ...
                      >
                        ...
                        <Link legacyBehavior href={userData?.role === 'SERVICE_PROVIDER' ? "/service-provider-manage" : "/profile"}>
                          <a className="dropdown-item d-flex align-items-center gap-2 px-3 py-2 rounded" style={{ fontSize: '14px' }}>
                        ...
                        <button
                          ...
                          style={{ fontSize: '14px', border: 'none', background: 'none', width: '100%', textAlign: 'left' }}
                        >
